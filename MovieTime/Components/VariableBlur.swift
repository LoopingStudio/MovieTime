...
open class VariableBlurUIView: UIVisualEffectView {
    ...
    public init(maxBlurRadius: CGFloat = 20, direction: VariableBlurDirection = .blurredTopClearBottom) {
    ...
    private func makeGradientImage(width: CGFloat = 100, height: CGFloat = 100, direction: VariableBlurDirection) -> CGImage { // much lower resolution might be acceptable
...
//        let ciGradientFilter =  CIFilter.smoothLinearGradient()
        ...
        ciGradientFilter.point1 = CGPoint(x: 0, y: 0) // small negative value looks better with vertical lines
